...
def create_summary():
    ...
    print(
        "   Polars DataFrame schema inference error when processing large SQL Server tables"
    )
    print(
        "   Error: 'could not append value: TREASURY SERVICES of type: str to the builder'"
    )

    print("\n🛠️ Solution Implemented:")
    print("   1. Two-stage DataFrame creation approach:")
    print(
        "      • First: Try direct Polars with extended schema inference (10,000 rows)"
    )
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(
            "The code changes appear to properly address the Polars schema inference issue."
        )
    else:
