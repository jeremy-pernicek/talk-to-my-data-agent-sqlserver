...
def test_polars_fix():
    ...
    problematic_data = [
        ...
        {"id": 3, "description": "TREASURY SERVICES", "value": "N/A"},  # This caused the original error
    ...
    try:
        ...
        print("  This is expected with truly mixed types - pandas fallback will handle it")
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*50}")
    if success:
        print("🎉 All tests passed! The fix should resolve the Polars schema inference issue.")
        print("\n📋 Summary of the fix:")
